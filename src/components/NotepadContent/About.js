...
import { FaInstagram, FaFacebook, FaBandcamp, FaEnvelope, BsTicketPerforated } from 'react-icons/fa'
    ...
    return (
        <div>
          ...
          <br/>
            ...
            <hr class="rounded"></hr> 
            <h3>next show:</h3>
            <p> <b>5.6.23 - Somerville, MA </b><a href='https://www.eventbrite.com/e/we-broke-the-weather-free-rock-the-cosmic-vultures-renee-maskin-tickets-593430676127' target='_blank' rel="noopener noreferrer"><BsTicketPerforated/></a><br/>
            The Jungle<br/>  
